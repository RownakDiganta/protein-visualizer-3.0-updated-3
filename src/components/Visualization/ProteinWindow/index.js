// src/components/Visualization/ProteinWindow/index.js
// Input card for the "protein window" feature: lets the user type a start/end
// residue range to focus the secondary zoomed-in visualization on.
